    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('neighborhood', models.ForeignKey(blank=True, default='1', on_delete=django.db.models.deletion.CASCADE, to='hood.neighborhood')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author_profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='hood.profile')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('Admin', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
                ('admin_profile', models.ForeignKey(blank=True, default='1', on_delete=django.db.models.deletion.CASCADE, to='hood.profile')),
                ('neighborhood', models.ForeignKey(blank=True, default='1', on_delete=django.db.models.deletion.CASCADE, to='hood.neighborhood')),
            ],
            options={
